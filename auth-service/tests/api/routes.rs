...
#[tokio::test]
async fn signup_returns_200_status_code() {
    let app = TestApp::new().await;
...
#[tokio::test]
async fn logout_returns_200_status_code() {
    let app = TestApp::new().await;
...
#[tokio::test]
async fn verify_2fa_returns_200_status_code() {
    let app = TestApp::new().await;
...
#[tokio::test]
async fn verify_token_returns_200_status_code() {
    let app = TestApp::new().await;
